...
## temple微信模板
```
{{city.DATA}} {{weather.DATA}}  {{low.DATA}}~{{high.DATA}}℃  {{wind.DATA}} 

当前湿度：{{humidity.DATA}} 

当前温度：{{temperature.DATA}} ℃ 

更新时间：{{lastUpdateTime.DATA}} 

我们已经恋爱了：{{love_days.DATA}}天 

距离苗苗生日：{{birthday_left.DATA}}天 

距离我生日：{{birthday_left2.DATA}} 天 
